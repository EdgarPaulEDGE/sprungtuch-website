      ...
      <div className="mx-auto max-w-5xl">
        <StaggerChildren
          className={cn(
            // Mobile: vertikal
            "flex flex-col gap-8",
            // Desktop: horizontal mit Verbindungslinien
        ...
        >
          {steps.map((step, index) => (
            ...
            >
              {/* Verbindungslinie (nur Desktop, nicht beim letzten) */}
              {index < steps.length - 1 && (
                <div className="absolute right-0 top-6 hidden h-0.5 w-full -translate-y-1/2 bg-warm-200 dark:bg-warm-700 md:block" />
              )}
